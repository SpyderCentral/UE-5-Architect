...
import { Folder, FileCode, CheckSquare, Settings, Cpu, Variable, ChevronDown, ChevronRight, Zap, ArrowRightCircle, Loader2, ShoppingBag, ExternalLink, Tag, ListOrdered, Braces, Workflow, SlidersHorizontal, MousePointer2, Box, FunctionSquare } from 'lucide-react';
