...
import { UserInput, GamePlan, ChatMessage, BlueprintSpec, MaterialSpec, EnhancedInputSpec, SavedProject, CppCode, VisionImage, VisualPrompt, NarrativeData, Quest, NPC, DialogueScript, LevelLayout, DesignReview, MarketplaceSuggestion, PerformanceAnalysis, MetaSoundSpec, PcgSpec, ConflictAnalysis, DriveSyncStatus, AppStep, BehaviorTreeSpec, OverseerReport } from '../types';
import { 
  generateGamePlan, 
  chatWithAgent, 
...
export const useGamePlan = () => {
  ...
  }, [currentProjectId, userInput, plan, chatHistory, blueprints, behaviorTrees, materials, inputs, metaSounds, pcgs, cppCodes, visionBoardImages, t3dExports, narrative, levelLayouts, designReview, overseerReport, performanceReports, installedAssets, drivePath, savedProjects]);
