 ...
 */
export function generateUE5PythonImporter(assetName: string, glbFilename: string, category: Asset3DCategory): string {
  const safeName = assetName.replace(/[^a-zA-Z0-9_]/g, '_');
 ...
 */
export function generateGodotScene(assetName: string, glbFilename: string, category: Asset3DCategory): string {
  const safeName = assetName.replace(/[^a-zA-Z0-9_]/g, '_');
 ...
 */
export function generateGodotScript(assetName: string, category: Asset3DCategory): string {
  const safeName = assetName.replace(/[^a-zA-Z0-9_]/g, '_');
 ...
 */
export function generateUnityPrefabManifest(assetName: string, glbFilename: string, category: Asset3DCategory): string {
  return JSON.stringify(
    {
      ...
      components: [
        ...
        { type: category === 'Character' ? "CapsuleCollider" : "BoxCollider", center: [0, 1, 0], size: [1.8, 2.0, 1.8] }
      ],
 ...
 */
export function generateUnityCSharpScript(assetName: string, category: Asset3DCategory): string {
